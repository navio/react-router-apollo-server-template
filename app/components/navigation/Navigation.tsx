...
export function Navigation({ className = '', orientation = 'horizontal' }: NavigationProps) {
                ...
                >
                  ...
                  <div>
                    ...
                    {metadata.description && (
                      <div className="text-sm text-gray-500 mt-0.5">{metadata.description}</div>
                    )}
                  </div>
                </Link>
              )
        ...
        {pathSegments.map((segment, index) => {
          ...
          return (
            <li key={path} className="flex items-center">
              ...
              {isLast ? (
                <span className="text-gray-500 font-medium capitalize">{segment}</span>
              ) : (
                <Link
                  to={path}
